...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'All transactions are sponsored by the platform. Creators and viewers pay nothing — no SUI required to upload, like, or comment.',
  },
] as const;
    ...
    >
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="text-muted-foreground mt-4 text-base sm:text-lg">
          A stack designed for creators who want ownership without giving up the
          snappy, scroll-friendly experience viewers expect.
        </p>
      </div>
