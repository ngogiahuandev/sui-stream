...
export const CLIP_UNLOCKED_EVENT_TYPE = SUI_STREAM_PACKAGE_ID
  ? `${SUI_STREAM_PACKAGE_ID}::${SUI_STREAM_ACCESS_MODULE}::ClipUnlocked`
  : '';

export const CLIP_ACCESS_TYPE = SUI_STREAM_PACKAGE_ID
  ? `${SUI_STREAM_PACKAGE_ID}::${SUI_STREAM_ACCESS_MODULE}::ClipAccess`
  : '';
